        ...
        <div className="flex flex-col flex-1 md:ltr:pr-32 md:rtl:pl-32">
          <Card component={motion.div} variants={item} className="w-full mb-32">
            ...
            <CardContent className="px-32 py-24">
              ...
              <div className="mb-24">
                <Typography className="font-semibold mb-4 text-15">Surname</Typography>
                <Typography>{user.user.family_name}</Typography>
              </div>

              <div className="mb-24">
                <Typography className="font-semibold mb-4 text-15">Username</Typography>
                <Typography>{user.user.name}</Typography>
              </div>

              <div className="mb-24">
                <Typography className="font-semibold mb-4 text-15">Email</Typography>
                <Typography>{user.user.sub}</Typography>
              </div>
